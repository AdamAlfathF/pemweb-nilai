		...
		<tbody>
		 <?php
            ...
            <tr>
                ...
                <td><?= $row['predikat']; ?></td>
                <td>
                    <a href="nilai-edit copy.php?nis=<?= $row['nis'];?>&kd_mp=<?=$row['kd_mp'];?>" class="btn btn-info btn-circle btn-sm">
                    <i class="fas fa-edit"></i>
                    </a>
                    <a href="nilai-hapus copy.php?nis=<?= $row['nis'];?>&kd_mp=<?=$row['kd_mp'];?>" class="btn btn-danger btn-circle btn-sm hapus">
